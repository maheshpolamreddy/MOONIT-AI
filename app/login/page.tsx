...
import { Send, Lock, Mail, ArrowRight, Github } from "lucide-react"
...
export default function LoginPage() {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black text-white">
            ...
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-white opacity-[0.02] blur-[100px] rounded-full pointer-events-none" />
            ...
            >
                ...
                >
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-2xl font-display font-semibold tracking-wider mb-2">Welcome Back</h1>
                        <p className="text-white/40 text-sm font-light">Sign in to continue chatting with MOONIT</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="w-full space-y-5">
                        ...
                        <button
                            ...
                            className="w-full bg-white/[0.03] border border-white/[0.08] text-white rounded-2xl py-3.5 font-medium text-sm transition-all hover:bg-white/[0.06] hover:border-white/20 active:scale-[0.98] flex items-center justify-center gap-3"
                        >
                    ...
                    <p className="mt-10 text-sm text-white/30 text-center">
                        New to the platform?{" "}
